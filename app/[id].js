    ...
    <View className="bg-slate-900 h-full flex justify-center items-center">
      <Stack.Screen
        options={{
          ...
          headerLeft: () => {},
          headerRight: () => <Text className="text-xl">{id}</Text>,
        }}
      />
      <ScrollView className="w-full">
        ...
        >
          <View className="flex-row justify-center items-center  ">
            <Image
              ...
              source={{ uri: namePokemon?.image }}
            />
          </View>
        </View>
        <View>
          <Text className="my-5 text-white text-3xl text-center font-bold">
            {" "}
            {namePokemon?.name}
          </Text>
        </View>
        <View className="flex-row justify-center items-center space-x-2">
          {namePokemon?.typePokemon.map((type, index) => (
            <View
              style={{ backgroundColor: typesPokemonColor[type] }}
              className="rounded-3xl px-8 py-1 mx-1 mt-2 mb-4"
              key={index}
            >
        ...
        <View className="flex-row justify-center w-auto items-center space-x-1">
          <View>
            <View
              style={{ backgroundColor: typesPokemonColor["normal"] }}
              className="rounded-3xl px-8 py-1 mx-1  mb-4"
            >
